...
class GlobalRoutePlanner(object):
    # Bu sınıf, çok yüksek seviyeli bir rota planı sağlar. 
    # GlobalRoutePlannerDAO nesnesine bir referans ileterek sınıfın örneklemesi yapılır.
    ...
    def setup(self):
        # Ayrıntılı topoloji için ilk sunucu veri aramasını gerçekleştirir
        # ve dünya haritasının grafik gösterimini oluşturur.
    ...
    def _build_graph(self):
        # Bu işlev, topolojinin bir networkx grafik gösterimini oluşturur.
        # Topoloji self._topology'den okunur.
        
        graph = nx.DiGraph()
        id_map = dict() # {(x,y,z): id, ... } yapılı harita
        road_id_to_edge = dict() # {road_id: {lane_id: edge, ... }, ... } yapılı harita
        ...
        for segment in self._topology:
            ...
            for vertex in entry_xyz, exit_xyz:
                # Benzersiz düğümlerin eklenmesi ve id_map'in doldurulması
    ...
    def _find_loose_ends(self):
        # Bu yöntem, bağlantısız bir ucu olan yol segmentlerini bulur 
        # ve bunları dahili grafik sunumuna ekler.
    ...
    def _localize(self, location):
        # Bu işlev, belirli bir konuma en yakın yol bölümünü bulur
    ...
    def _lane_change_link(self):
        # Bu yöntem, şerit değişikliklerinin kullanılabilirliğini temsil eden 
        # topoloji grafiğine sıfır maliyetli bağlantılar yerleştirir.
    ...
    def _distance_heuristic(self, n1, n2):
        # Kendi grafiğinde yol aramak için mesafe sezgisel hesaplayıcı
    ...
    def _path_search(self, origin, destination):
        # Bu işlev, mesafe sezgisel olarak A * aramasını kullanarak başlangıç 
        # ve varış noktasını birbirine bağlayan en kısa yolu bulur.
    ...
    def _successive_last_intersection_edge(self, index, route):
        # Bu yöntem, rotadaki bir başlangıç dizininden son art arda kesişme kenarını döndürür. 
        # Bu, doğru dönüş kararlarını hesaplamak için küçük kavşak kenarlarını geçmeye yardımcı olur.
    ...
    def _turn_decision(self, index, route, threshold=math.radians(35)):
        # Bu yöntem, geçerli rota listesi dizini çevresindeki 
        # kenar çiftleri için dönüş kararını (RoadOption) döndürür
    ...
    def trace_route(self, origin, destination):
        # Bu yöntem, başlangıçtan hedefe (carla.Waypoint, RoadOption) listesini döndürür
